...
async function main() {
  console.log("🔍 Verifying Token on BSC Mainnet");
  console.log("=" .repeat(50));
  
  // Token details from deployment
  const tokenAddress = "0xa25adF672802DFc0b9E32Fd530f5F5220F9072E8";
  const txHash = "0x76ea0ba217595ebcc3762559d38269df6200ef6e502f443aa3b76ccf2ca425a2";
  ...
  if (Number(network.chainId) !== 56) {
    console.error("❌ ERROR: This script is designed for BSC mainnet (Chain ID: 56)");
  ...
  try {
    ...
    try {
      ...
      console.log("   Service Fee:", ethers.formatEther(serviceFee), "BNB");
    ...
    console.log("\n✅ Deployment Verification:");
    console.log("=" .repeat(40));
    console.log("   ✅ Token deployed successfully on BSC mainnet");
