...
async function main() {
  console.log("🔍 Verifying Token on Base Mainnet");
  console.log("=" .repeat(50));
  
  // Token details from deployment
  const tokenAddress = "0xa25adF672802DFc0b9E32Fd530f5F5220F9072E8";
  const txHash = "0x064e14cb443e635075e5ff8ce5f1e50f35184779d0af275fb004d956ff3cd39a";
  ...
  try {
    ...
    console.log("\n✅ Deployment Verification:");
    console.log("=" .repeat(40));
    console.log("   ✅ Token deployed successfully on Base mainnet");
