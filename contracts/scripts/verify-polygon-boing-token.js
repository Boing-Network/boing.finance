...
async function main() {
  console.log("🔍 Verifying Token on Polygon Mainnet");
  ...
  try {
    ...
    try {
      ...
      console.log("   Service Fee:", ethers.formatEther(serviceFee), "MATIC");
    ...
    console.log("\n✅ Deployment Verification:");
    console.log("=" .repeat(40));
    console.log("   ✅ Token deployed successfully on Polygon mainnet");
