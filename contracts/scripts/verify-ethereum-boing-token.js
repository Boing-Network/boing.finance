...
async function main() {
  console.log("🔍 Verifying Token on Ethereum Mainnet");
  console.log("=" .repeat(50));
  
  // Token details from deployment
  const tokenAddress = "0x40F54BB6772656d2484A3483A0bC064fdc5D76e1";
  const txHash = "0xd96ee69ec33e79f29b2acf60cb5e30f7386cb0435dbc7a04713b2c6b95cdbe4c";
  ...
  try {
    ...
    console.log("\n✅ Deployment Verification:");
    console.log("=" .repeat(40));
    console.log("   ✅ Token deployed successfully on Ethereum mainnet");
