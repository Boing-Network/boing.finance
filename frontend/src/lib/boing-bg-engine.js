...
class BoingBackground {
  constructor(canvas, config) {
    ...
    this._resize();
    this._init();
    this._onResize = () => { this._resize(); this._init(); };
...
const BOING_BG_CONFIGS = {
  ...
  finance: {
    landing: {
      ...
      starOpacityMax: 0.62,
      nebulaClouds: [
        { x: 0.10, y: 0.09, r: 300, color: '#5b21b6', opacity: 0.058 },
        { x: 0.78, y: 0.07, r: 260, color: '#00e5ff', opacity: 0.042 },
        { x: 0.48, y: 0.20, r: 200, color: '#7c3aed', opacity: 0.036 },
        { x: 0.62, y: 0.14, r: 140, color: '#00ff88', opacity: 0.026 },
      ],
...
// ES module export for React app
