...
const NetworksSection = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-white mb-6">Supported Networks</h2>
        ...
        <div key={index}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {category.networks.map((network, idx) => (
              <div key={idx} className="bg-gray-750 rounded-lg p-6 border border-gray-600">
                ...
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-gray-300 font-medium">{network.symbol}</span>
                </div>
      ...
      {/* Network Features */}
      <div>
        <h3 className="text-2xl font-bold text-white mb-6">Network Features</h3>
        <div className="grid md:grid-cols-2 gap-6">
          {networkFeatures.map((feature, index) => (
            <div key={index} className="bg-gray-750 rounded-lg p-6 border border-gray-600">
      ...
      {/* Network Comparison */}
      <div>
        <h3 className="text-2xl font-bold text-white mb-6">Network Comparison</h3>
        <div className="bg-gray-750 rounded-lg p-6 border border-gray-600 overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-600">
                <th className="text-left text-white font-semibold py-3">Network</th>
                <th className="text-center text-white font-semibold py-3">Type</th>
                <th className="text-center text-white font-semibold py-3">Block Time</th>
                <th className="text-center text-white font-semibold py-3">Gas Limit</th>
                <th className="text-center text-white font-semibold py-3">Features</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-700">
                <td className="text-gray-300 py-3">Ethereum</td>
                <td className="text-center text-gray-300 py-3">Layer 1</td>
                <td className="text-center text-gray-300 py-3">12s</td>
                <td className="text-center text-gray-300 py-3">30M</td>
                <td className="text-center text-gray-300 py-3">High Security</td>
              </tr>
              <tr className="border-b border-gray-700">
                <td className="text-gray-300 py-3">Polygon</td>
                <td className="text-center text-gray-300 py-3">Sidechain</td>
                <td className="text-center text-gray-300 py-3">2s</td>
                <td className="text-center text-gray-300 py-3">30M</td>
                <td className="text-center text-gray-300 py-3">Low Fees</td>
              </tr>
              <tr className="border-b border-gray-700">
                <td className="text-gray-300 py-3">Arbitrum</td>
                <td className="text-center text-gray-300 py-3">Rollup</td>
                <td className="text-center text-gray-300 py-3">1s</td>
                <td className="text-center text-gray-300 py-3">100M</td>
                <td className="text-center text-gray-300 py-3">Low Fees</td>
              </tr>
              <tr className="border-b border-gray-700">
                <td className="text-gray-300 py-3">Base</td>
                <td className="text-center text-gray-300 py-3">Rollup</td>
                <td className="text-center text-gray-300 py-3">2s</td>
                <td className="text-center text-gray-300 py-3">30M</td>
                <td className="text-center text-gray-300 py-3">Coinbase Backed</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {/* Adding New Networks */}
      <div>
        <h3 className="text-2xl font-bold text-white mb-6">Adding New Networks</h3>
        <div className="bg-gray-750 rounded-lg p-6 border border-gray-600">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-white font-semibold mb-1">Network Requirements</h4>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-white font-semibold mb-1">Configuration</h4>
                <p className="text-gray-300 text-sm">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-white font-semibold mb-1">Contract Deployment</h4>
                <p className="text-gray-300 text-sm">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-white font-semibold mb-1">Bridge Integration</h4>
                <p className="text-gray-300 text-sm">
