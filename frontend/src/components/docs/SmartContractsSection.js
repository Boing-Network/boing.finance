    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold  mb-4"
          style={{ color: 'var(--text-primary)'  }}>Smart Contracts</h2>
        <p className=" text-lg"
      ...
      <div className="rounded-lg p-6 border"
        ...
        <h3 className="text-xl font-semibold  mb-4"
          style={{ color: 'var(--text-primary)'  }}>Select Network</h3>
        <div className="flex flex-wrap gap-3">
          {supportedNetworks.map(({ chainId, network }) => (
            <button
              ...
              style={{
                color: selectedNetwork === chainId.toString() ? 'var(--text-primary)' : 'var(--text-secondary)'
              }}
            >
      ...
      {currentNetwork && (
        <div className="rounded-lg p-6 border"
          ...
          style={{ color: 'var(--text-primary)'  }}>{currentNetwork.name}</h3>
      ...
      {contracts && (
        <div className="space-y-6">
          ...
          style={{ color: 'var(--text-primary)'  }}>Deployed Contracts</h3>
      ...
      {(!contracts || Object.keys(contracts).length === 0) && (
        <div className="rounded-lg p-8 border text-center"
          ...
          style={{ color: 'var(--text-primary)'  }}>No Contracts Deployed</h3>
      ...
      <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-6">
        <h3 className="text-lg font-semibold  mb-3"
          style={{ color: 'var(--text-primary)'  }}>✅ Contract Verification</h3>
        <p className=" mb-4"
          style={{ color: 'var(--text-secondary)'  }}>
      ...
      <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 "
          ...
          <div>
            <h4 className="font-semibold  mb-2"
          style={{ color: 'var(--text-primary)'  }}>Platform Security</h4>
            <ul className="space-y-1 text-sm">
...
const ContractCard = ({ name, address, network, icon, description }) => {
  ...
  return (
    <div className="rounded-lg p-6 border hover:border-gray-500 transition-colors"
          style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--bg-card)' }}>
      ...
      <div className="space-y-3">
        ...
        <div className="flex space-x-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gray-600 hover:bg-gray-700  px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center space-x-2"
          style={{ color: 'var(--text-primary)'  }}
          >
            <span>📄</span>
