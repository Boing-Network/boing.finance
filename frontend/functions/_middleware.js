...
const CONTENT_SECURITY_POLICY = [
  ...
  "connect-src 'self' https://*.workers.dev https://*.etherscan.io https://*.infura.io https://*.alchemyapi.io https://*.g.alchemy.com https://*.pinata.cloud https://*.web3.storage https://*.nft.storage https://*.storacha.network https://static.cloudflareinsights.com https://*.cloudflareinsights.com https://api.coingecko.com https://api.geckoterminal.com https://api.dexscreener.com https://www.walletlink.org https://api.thegraph.com https://gateway-arbitrum.network.thegraph.com https://gateway.network.thegraph.com https://*.network.thegraph.com https://chain-proxy.wallet.coinbase.com https://api.dfuse.io https://testnet-rpc.boing.network https://*.boing.network https://*.solana.com https://api.mainnet-beta.solana.com https://api.devnet.solana.com wss://*.solana.com https://li.quest https://*.jup.ag https://*.helius-rpc.com https://api.helius.xyz wss://*.helius-rpc.com https://*.publicnode.com https://*.drpc.org https://rpc.ankr.com https://*.onfinality.io https://solana.llamarpc.com wss://api.dexscreener.com wss://*.infura.io wss://*.alchemyapi.io wss://*.g.alchemy.com wss://www.walletlink.org",
